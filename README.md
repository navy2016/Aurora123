...
*   **Windows**: Native-like experience with fluent UI and Mica effect.
*   **macOS**: Native-like experience with optimized layout.
*   **Linux**: Full desktop support.
*   **Android / iOS**: Adapted for touch and mobile layouts with bottom sheet interaction.
